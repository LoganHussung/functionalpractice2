...
function reject(list, predicate) {
  var results = list.filter(function(v){
    return !predicate(v);
  });
  return results;
}
...
function find(list, predicate) {
  return list.reduce(function(a, v){
    var resultOfPredicate = predicate(v)
